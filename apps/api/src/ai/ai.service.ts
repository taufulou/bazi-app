...
export class AIService implements OnModuleInit {
  ...
  generateBirthDataHash(
    ...
    const PRE_ANALYSIS_VERSIONS: Record<string, string> = {
      ...
      [ReadingType.ANNUAL]:        'v2.5.1',  // PR#56 — annual 官殺 vocab fix (OFFICIAL_GODS): compute_annual_career_analysis (官印相生) + compute_indirect_effects (官殺間接催財) + _compute_single_month aspects.career (官殺當令) now fire for 偏官 flow-years/months (were dead against the 七殺 literal). v2.5.0: PR#55 followup SPOUSE_STAR_FEMALE 偏官 配偶星. v2.4.0: Phase 12h.B Item 2 傷官見官 favorability propagation
