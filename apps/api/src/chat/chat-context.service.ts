...
const PRE_ANALYSIS_VERSIONS_FOR_CHAT_HASH = {
  ...
  FORTUNE_MONTH: 'v1.0.2', // MONTH scope (Phase 2) — used by `fort-month=` + `pa-fort-month=`. Bumped PR#56: annual 官殺 vocab fix (OFFICIAL_GODS) shifts MONTH dimensions.career (the monthly chat slim forwards `dimensions`, derived from aspects.career) for 偏官 months. v1.0.1: PR#55-followup SPOUSE_STAR_FEMALE 偏官 romance fix.
  ...
  FORTUNE_YEAR: 'v1.1.2', // Bumped PR#56: annual 官殺 vocab fix (OFFICIAL_GODS) cascades into the YEAR 事業 aggregation (the yearly chat slim forwards `dimensions`) for 偏官 flow-months. v1.1.1: PR#55-followup SPOUSE_STAR_FEMALE 偏官 romance cascade. v1.1.0: Phase 3.5c initial.
} as const;
