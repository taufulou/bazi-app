...
async function main() {
  ...
  const services = [
    ...
    { slug: 'love', nameZhTw: '八字愛情姻緣', nameZhCn: '八字爱情姻缘', descriptionZhTw: '深入分析桃花運、配偶星、姻緣宮位，掌握感情時機與婚配建議', descriptionZhCn: '深入分析桃花运、配偶星、姻缘宫位，掌握感情时机与婚配建议', type: ReadingType.LOVE, creditCost: 3, sortOrder: 4 },
