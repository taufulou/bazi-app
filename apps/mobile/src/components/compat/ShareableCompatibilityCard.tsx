...
const styles = StyleSheet.create({
  ...
  name: { fontFamily: fonts.serif, fontSize: fontSize.lg, fontWeight: '700', color: colors.textPrimary, flexShrink: 1 },
  ...
  scoreNumber: { fontFamily: fonts.serif, fontSize: 40, fontWeight: '800', lineHeight: 44 },
  ...
  labelText: { fontFamily: fonts.serif, fontSize: fontSize.lg, fontWeight: '700', color: colors.textOnRed },
  ...
  metricValue: { fontFamily: fonts.serif, fontSize: fontSize.lg, fontWeight: '800', color: colors.textAccent },
