...
const styles = StyleSheet.create({
  ...
  scoreNumber: { fontFamily: fonts.serif, fontSize: 52, fontWeight: '800', lineHeight: 56 },
  scoreUnit: { fontSize: fontSize.sm, color: colors.textMuted, marginBottom: 8, marginLeft: 2 },
  scoreLabel: { fontFamily: fonts.serif, fontSize: fontSize.lg, fontWeight: '700', color: colors.textAccent, marginTop: 2 },
  ...
  reassuranceText: { fontSize: fontSize.sm, color: colors.textSecondary, lineHeight: 20 },
  masterNote: {
    alignSelf: 'stretch',
  ...
  masterNoteTitle: { fontFamily: fonts.serif, fontSize: fontSize.base, fontWeight: '700', color: colors.textAccent },
  masterNoteSummary: { fontSize: fontSize.sm, color: colors.textPrimary, lineHeight: 21 },
  ...
  masterNoteEncouragement: { fontSize: fontSize.sm, color: colors.textSecondary, lineHeight: 21 },
