...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: fonts.serif, fontSize: fontSize.lg, fontWeight: '700', color: colors.textAccent },
  hourWarn: {
  ...
  hourWarnLead: { fontSize: fontSize.sm, color: colors.textPrimary, lineHeight: 20, marginBottom: 2 },
  hourWarnItem: { fontSize: fontSize.sm, color: colors.textSecondary, lineHeight: 19 },
  ...
  revealBtnText: { fontFamily: fonts.serif, fontSize: fontSize.lg, fontWeight: '700', color: colors.textOnRed },
