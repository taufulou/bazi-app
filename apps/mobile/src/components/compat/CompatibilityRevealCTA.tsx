...
const styles = StyleSheet.create({
  ...
  hourWarnLead: { fontSize: fontSize.sm, color: colors.textPrimary, lineHeight: 22, marginBottom: 2 },
  hourWarnItem: { fontSize: fontSize.sm, color: colors.textSecondary, lineHeight: 22 },
