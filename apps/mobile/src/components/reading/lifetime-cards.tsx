...
const cc = StyleSheet.create({
  ...
  title: { fontFamily: fonts.serif, fontSize: fontSize.lg, fontWeight: '700', color: colors.textAccent, flex: 1 },
  zodiacBadge: {
    borderRadius: 999,
  ...
  archetypeValue: { fontFamily: fonts.serif, fontSize: fontSize.xl, fontWeight: '700', color: colors.textAccent },
  layers: { gap: spacing.md },
  layer: { gap: 2 },
  layerLabel: { fontSize: fontSize.sm, fontWeight: '700', color: colors.textSecondary },
  layerValue: { fontSize: fontSize.base, color: colors.textPrimary, lineHeight: 24 },
  stats: {
    gap: spacing.sm,
...
const det = StyleSheet.create({
  ...
  explain: { fontSize: fontSize.sm, color: colors.textSecondary, lineHeight: 20 },
  ...
  dpdTitle: { fontFamily: fonts.serif, fontSize: fontSize.lg, fontWeight: '700', color: colors.textAccent },
  ...
  dpdBlockText: { fontSize: fontSize.base, color: colors.textPrimary, lineHeight: 24 },
});
