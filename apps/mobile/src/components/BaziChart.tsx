...
const styles = StyleSheet.create({
  ...
  headerText: { fontFamily: fonts.serif, color: colors.textOnRed, fontSize: fontSize.lg, fontWeight: '700' },
  ...
  ganZhi: { fontFamily: fonts.serif, fontSize: fontSize.xxl, fontWeight: '700' },
  ...
  sectionTitle: { fontFamily: fonts.serif, fontSize: fontSize.base, fontWeight: '700', color: colors.textAccent },
  ringRow: { flexDirection: 'row', justifyContent: 'space-between' },
  ringItem: { alignItems: 'center' },
  ringChar: { fontFamily: fonts.serif, fontSize: fontSize.lg, fontWeight: '700', marginTop: -46, marginBottom: 26 },
  ...
  luckGz: { fontFamily: fonts.serif, fontSize: fontSize.lg, fontWeight: '700' },
