...
const styles = StyleSheet.create({
  ...
  takeaway: { ...T.body, color: colors.textAccent, borderLeftWidth: 3, borderLeftColor: colors.textAccent, paddingLeft: spacing.sm },
  ...
  breakdownBody: { ...T.body, color: colors.textSecondary },
  ...
  adviceItem: { ...T.body, color: colors.textSecondary },
